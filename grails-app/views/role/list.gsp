                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="development" title="${message(code: 'role.development.label', default: 'Development')}" />
                        
                            <th><g:message code="role.project.label" default="Project" /></th>
                    ...
                    <g:each in="${roleInstanceList}" status="i" var="roleInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:formatBoolean boolean="${roleInstance.development}" /></td>
                        
                            <td>${fieldValue(bean: roleInstance, field: "project")}</td>

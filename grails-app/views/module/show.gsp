            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="module.instances.label" default="Instances" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="module.props.label" default="Props" /></td>

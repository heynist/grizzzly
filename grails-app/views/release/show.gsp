            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="release.name.label" default="Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="release.iterations.label" default="Iterations" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="release.project.label" default="Project" /></td>
                            
                            <td valign="top" class="value"><g:link controller="project" action="show" id="${releaseInstance?.project?.id}">${releaseInstance?.project?.encodeAsHTML()}</g:link></td>

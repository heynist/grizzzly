                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="project.subProjectOf.label" default="Sub Project Of" /></th>
                        
                            <g:sortableColumn property="website" title="${message(code: 'project.website.label', default: 'Website')}" />
                    ...
                    <g:each in="${projectInstanceList}" status="i" var="projectInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: projectInstance, field: "subProjectOf")}</td>
                        
                            <td>${fieldValue(bean: projectInstance, field: "website")}</td>

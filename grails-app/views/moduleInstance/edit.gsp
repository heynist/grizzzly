    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${moduleInstanceInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="props"><g:message code="moduleInstance.props.label" default="Props" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: moduleInstanceInstance, field: 'props', 'errors')}">
                                    <g:select name="props" from="${grizzzly.ModulePropertyInstance.list()}" multiple="yes" optionKey="id" size="5" value="${moduleInstanceInstance?.props*.id}" />
                                </td>
                            </tr>
